      ...
      >
        ...
        <TabsContent value="preview" className="mt-0 border-none p-0">
          <ScrollArea className="h-[600px] w-full rounded-md border">
            <div className="p-4">
              {content ? (
                <div className="prose prose-sm max-w-none dark:prose-invert prose-headings:font-semibold prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg prose-a:text-brand hover:prose-a:text-brand-dark prose-img:rounded-md prose-img:mx-auto prose-code:bg-muted prose-code:p-1 prose-code:rounded prose-code:text-sm">
                  <ReactMarkdown
